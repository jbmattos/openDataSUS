...
def verb():
    '''
    This function is executed when argparse --verb
    '''
...
def save():
    '''
    Save new Dictionary of Features for srag2020 and srag2021
    '''
...
if __name__ == '__main__':
    ...
    parser.add_argument("--nosave", default=True, action='store_false', 
                        help="Deactivate the option to save the new dictionaries for srag2020/21 or not [default:True]")
